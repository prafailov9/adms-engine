...
class AlgorithmsTest {
    ...
    public void firstSwapTest() {
        ...
        Assertions.assertArrayEquals(new String[]{"ay", "by", "cy", "cx", "bx", "ax", "aaa", "azz"},
                arr);
    }
    ...
    public void fizzBuzzTest() {
        ...
        Assertions.assertArrayEquals(
                new String[]{"1", "2", "Fizz", "4", "Buzz", "Fizz", "7", "8", "Fizz", "Buzz"}, arr);
    }
    ...
    public void denseRankingTest() {
        List<Integer> res = denseRanking(
                new int[]{100, 90, 90, 80, 80, 80, 75, 70, 70, 70, 70, 70, 60});
        int[] arr = new int[res.size()];
...
//        int res = longestConsecutiveSequence(new int[] {100, 4, 200, 1, 3, 2});
    ...
    public void groupAnagramsTest() {
        List<List<String>> res = groupAnagrams(
                new String[]{"foo", "bar", "enlist", "inlets", "listen", "ofo", "silent", "bra"});
    }
    ...
    public void mergeSortedListsTest() {
        ...
        Assertions.assertArrayEquals(new Integer[]{1, 1, 2, 3, 4, 4, 5, 6},
...
//                Arrays.asList(15, 18)
    ...
    public void matchingStringsTest() {
        List<Integer> res = matchingStrings(Arrays.asList("ab", "ab", "abc"),
    ...
    @Test
    public void smallestMissingPositiveTest() {
        List<Integer> list = new ArrayList<>();
        list.add(3);
        list.add(4);
        list.add(-1);
        list.add(1);
        int res = Algorithms.findSmallestMissingPositive(list);
        Assertions.assertEquals(2, res);
    }

    @Test
    public void isAlphabeticPalindromeTest() {
        String code = "abc123cba";

        boolean res = Algorithms.isAlphabeticPalindrome(code);
    ...
    public void isPalindromeV2Test() {
        ...
        boolean res = Algorithms.isPalindromeV2(word);
    ...
    public void minCostTest() {
        ...
        long res = Algorithms.minimumCost(source, target, original, changed, cost);
    ...
    @Test
    public void lenConsSubarrayTest() {
        int[] arr1 = new int[]{1, 2, 3, 1, 2, 3, 4, 5};
        int[] arr2 = new int[]{};
        int[] arr3 = new int[]{7};
        int[] arr4 = new int[]{4, 4, 4, 4};
        int[] arr5 = new int[]{1, 2, 3, 4, 5};
        int[] arr6 = new int[]{1, 2, 1, 2, 1, 2};
        int[] arr7 = new int[]{-1, -2, -3, -2, -1, 0};
        int[] arr8 = new int[]{5, 1, 2, 3, 4, 2};

        System.out.printf("[1, 2, 3, 1, 2, 3, 4, 5] = %s%n", lenConsSubarray(arr1));
        System.out.printf("[] = %s%n", lenConsSubarray(arr2));
        System.out.printf("[7] = %s%n", lenConsSubarray(arr3));
        System.out.printf("[4, 4, 4, 4] = %s%n", lenConsSubarray(arr4));
        System.out.printf("[1, 2, 3, 4, 5] = %s%n", lenConsSubarray(arr5));
        System.out.printf("[1, 2, 1, 2, 1, 2] = %s%n", lenConsSubarray(arr6));
        System.out.printf("[-1, -2, -3, -2, -1, 0] = %s%n", lenConsSubarray(arr7));
        System.out.printf("[5, 1, 2, 3, 4, 2] = %s%n", lenConsSubarray(arr8));
    }

    private int lenConsSubarray(int[] arr) {
